// Borrowing snowcode from the FxEmbed project, license MIT
// Thank you @dangeredwolf
// https://github.com/FxEmbed/FxEmbed/blob/main/src/helpers/snowcode.ts
...
export const decodeSnowcode = (numStr: string) => {
  ...
  for (let i = 0; i < str.length; i += 2) {
    ...
    const index = Number.parseInt(codeStr, 10);
